...
This example reads the header row and the first three rows of cells from the tab named 'Stopped' of the Excel XLSX Worksheet which is the output in example #5 or in example #6:
```
